...
if __name__ == '__main__':
    data_info = json.load(open('../configs/data/dataset_info.json', 'r', encoding='utf-8-sig'))
    ...
    json.dump(data_info, open('../configs/data/dataset_info.json', 'w'), ensure_ascii=False, indent=4)
